 ...
 * 
 * Implement a last-in-first-out (LIFO) stack using an ArrayList. The implemented stack should support all the functions of a normal stack (push, pop, peek, and isEmpty).
 * 
